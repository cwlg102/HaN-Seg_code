...
def inference_hanseg(ct_sitk):
    ...
    for oar, bbox in oar_end_check.items():
        ...
        with torch.no_grad():
            ...
            val_outputs_fold0 = sliding_window_inference(val_inputs, (192, 192, 32), 4, model_fold_0, overlap=0.50)
            if R_conv_mode:
                val_outputs_fold1 = sliding_window_inference(val_inputs_flip, (192, 192, 32), 4, model_fold_1, overlap=0.52)
                val_outputs_fold2 = sliding_window_inference(val_inputs_flip, (192, 192, 32), 4, model_fold_2, overlap=0.50)
                val_outputs_fold4 = sliding_window_inference(val_inputs_flip, (192, 192, 32), 4, model_fold_4, overlap=0.50)
                val_outputs_fold5 = sliding_window_inference(val_inputs_flip, (192, 192, 32), 4, model_fold_5, overlap=0.50)
            else:
                val_outputs_fold1 = sliding_window_inference(val_inputs, (192, 192, 32), 4, model_fold_1, overlap=0.52)
                val_outputs_fold2 = sliding_window_inference(val_inputs, (192, 192, 32), 4, model_fold_2, overlap=0.50)
                val_outputs_fold4 = sliding_window_inference(val_inputs, (192, 192, 32), 4, model_fold_4, overlap=0.50)
                val_outputs_fold5 = sliding_window_inference(val_inputs, (192, 192, 32), 4, model_fold_5, overlap=0.50)
        ...
        last_outputs_fold0 = last_outputs_fold0 + last_outputs_fold1 + last_outputs_fold2 + last_outputs_fold4 + last_outputs_fold5
    ...
    model_fold_5.eval()
    with torch.no_grad():
        val_outputs_fold0 = sliding_window_inference(val_inputs, (192, 192, 32), 4, model_fold_0, overlap=0.70)
        val_outputs_fold1 = sliding_window_inference(val_inputs, (192, 192, 32), 4, model_fold_1, overlap=0.60)
        val_outputs_fold2 = sliding_window_inference(val_inputs, (192, 192, 32), 4, model_fold_2, overlap=0.50)
        val_outputs_fold4 = sliding_window_inference(val_inputs, (192, 192, 32), 4, model_fold_4, overlap=0.50)
        val_outputs_fold5 = sliding_window_inference(val_inputs, (192, 192, 32), 4, model_fold_5, overlap=0.80)
        last_outputs_fold0 = torch.argmax(val_outputs_fold0, dim=1).detach().cpu()[0].numpy()
        last_outputs_fold1 = torch.argmax(val_outputs_fold1, dim=1).detach().cpu()[0].numpy()
        last_outputs_fold2 = torch.argmax(val_outputs_fold2, dim=1).detach().cpu()[0].numpy()
        last_outputs_fold4 = torch.argmax(val_outputs_fold4, dim=1).detach().cpu()[0].numpy()
